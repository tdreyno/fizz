...
- 77f2d58: Add additive, opt-in runtime and builder APIs.
...
- 5a99ffc: Add composed state-path introspection and nested child-entry ergonomics.
...
- 46464ec: Add a declarative, ordered-guard `route()` builder for state handlers.
...
- acd6247: Add transition observation and flow-history introspection to the runtime.
